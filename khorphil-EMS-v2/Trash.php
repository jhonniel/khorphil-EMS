...
<body>
  <nav>
    ...
    <ul>
      ...
      <li><a class="active" href="#">Trash</a></li>
    </ul>
  </nav>
    ...
    <div class="right">
      <table>
        <thead>
           ...
           <tbody>
			  <?php 
				$sql="SELECT * FROM employee WHERE Employee_Status='Inactive' ORDER BY Employee_ID ASC";
              ...
              ?>
                <tr>
				  ...
				  <td><a  href='Process.php?res=<?php echo $row['Employee_ID']; ?>' class="btn btn-primary a-btn-slide-text">
                     <span class="glyphicon glyphicon-repeat" aria-hidden="true"></span>
                  <span>Restore</span></a></td> 
